...
import com.example.infomanager.UserDetails.PersonalDetailsActivity;
import com.example.infomanager.remote.APIUtils;
import com.example.infomanager.remote.UserService;
...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(login.this, "Login Details Empty!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(login.this, "SignUp Details Empty!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void signUpUser(final User user, final String email)
    {
        ...
        call.enqueue(new Callback<LoginSignupData>() {
            ...
            @Override
            public void onFailure(Call<LoginSignupData> call, Throwable t) {
                Toast.makeText(login.this, "Signup Failed: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void serverTest() {
        ...
        call.enqueue(new Callback<ServerTest>() {
            ...
            public void onResponse(Call<ServerTest> call, Response<ServerTest> response) {
                ...
                Toast.makeText(login.this, "ServerStatus : " + response.body().getStatus(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<ServerTest> call, Throwable t) {
                Toast.makeText(login.this, "ServerStatus : Down : " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
